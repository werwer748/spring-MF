...
<head>
    ...
    <script>
        ...
        function goSave(isbn) {
            ...
            let author = authorsElement.textContent;
            ...
            fetch(url)
                ...
                .then(data => {
                    ...
                    data.documents.forEach(book => {
                        ...
                        // const text = price + ":" + isbn + ":" + publisher + ":";
                        // const tags = "<a href="+ url + ">" + title + "</a><img src='" + thumbnail +"' />"
                        // bookInfo.innerHTML = text + tags;
