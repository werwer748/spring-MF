    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="text-center">
                ...
                <button class="btn btn-sm btn-warning" onclick="goDel(${product_number})">삭제</button>
                <button class="btn btn-sm btn-secondary" onclick="location.href='${cpath}/list'">목록</button>
            </div>
        </div>
